import { sendGif } from "./send";

export async function getGif(search_term = null, id = null, preview = true) {
...
export function createGIF(srcObj) {
...
* "name": "#why"
*/
export function createCategoryGif(rawGifObj, APIKey) {
...
export function createGifPopup() {
