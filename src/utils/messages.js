...
export function showNotif(username, content, reason = "msg") {
...
export function createDMTopBar(data) {
...
export function createNewMessage(msg) {
...
export function addMessage(msg, author = null) {
...
export function closeDM(response) {
  try {
...
export function createDmLink(dmRaw) {
